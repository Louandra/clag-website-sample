...
var pictures = ['image-1', 'image-2', 'image-3', 'image-4', 'image-5']
...
$( document ).ready(function(){
  ...
  $('h1#change-picture').on('click', function () {
    ...
    var randomBackground = pictures[Math.floor(Math.random() * pictures.length)];
   ...
   $('div#pictures').css('background', imageUrl)
